...
public class VentanaJuego extends JFrame {
	...
	private int sumatorio=0;			//Variable para convertir SUMATORIO_TEXTO en una operación matemática
	private JLabel cartel2;
	private boolean edit_num=true;		//Variable para dejar introducir números
	private boolean edit_sign=false;	//Variable para dejar introducir signos
	private boolean operacion=true;		//En true sumará, en false restará
	...
	public VentanaJuego() {
		...
		labelnotoques.setText("No toques ese botón");
	...
	// P06 Inner class para los dados de 3 números
	...
	//P06 Inner class para los dados de 6 números
